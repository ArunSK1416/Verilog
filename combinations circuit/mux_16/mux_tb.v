...
multiplex12 uut (.k0(k0), .k1(k1), .k2(k2), .k3(k3),.k4(k4), .k5(k5), .k6(k6), .k7(k7),.k8(k8), .k9(k9), .k10(k10), .k11(k11),
                 .k12(k12), .k13(k13), .k14(k14), .k15(k15),.x(x),.s0(s0), .s1(s1), .s2(s2), .s3(s3));
